...
public class JFMostrarTodos extends JFrame{
	...
	public class JBMostrarTodos extends JButton{	
		...
		public class ALMostrarTodos implements ActionListener{
			...
			public void actionPerformed(ActionEvent e) {
				...
				Controlador.getInstance().actualiza(Controlador.MOSTRAR_TODOS_PRESO, null);
			}
		}
	...
	private class Modelo extends AbstractTableModel {
		...
		public Modelo() {
			this.listaPresos = new ArrayList<TransferPresos>();
		}
		...
		public Object getValueAt(int rowIndex, int columnIndex) {
			TransferPresos presos = this.listaPresos.get(rowIndex);
			Object ret = null;
			switch (columnIndex) {
				case 0: ret = presos.getId(); break;
				case 1: ret = presos.getApellido(); break;
				case 2: ret = presos.getNombre(); break;
				case 3: ret = presos.getDni(); break;
			}
			return ret;
		}
		
		public void setData(List<TransferPresos> listaSectores) {
			this.listaPresos = listaSectores;
		}
		
		private List<TransferPresos> listaPresos;
		
	}

	
	public JFMostrarTodos() {
		super("Muestra todos los Presos");
		setSize(480,420);
	...
	private void initGUI() {
		...
		jpTabla.setBorder(new TitledBorder(new LineBorder(Color.LIGHT_GRAY),"Presos",
	...
	public void informar(int resultado, List<TransferPresos> listaPresos) {
		switch (resultado) {
			case Controlador.OPERACION_CORRECTA: this.lista = listaPresos;
												this.modelo.setData(listaPresos); 
												this.modelo.fireTableDataChanged();
												break;
			
			case Controlador.PRESO_NO_EXISTENTE: JOptionPane.showMessageDialog
													(this, "No se han encontrado presos", "Error",
	...
	private void abrirVentana(JFMostrarUno2 vent) {
		...
		vent.setLocation(vent.getLocation().x, vent.getLocation().y + 150);
	...
	private List<TransferPresos> lista;
