...
public class JFMostrarUno extends JFrame{
		...
		public class ALMostrarUno implements ActionListener{
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					Controlador.getInstance().actualiza(Controlador.MOSTRAR_UNA_ACTIVIDAD, id);
	...
	private void initGUI() {
		...
		JLabel texto = new JLabel("Introduzca el ID de la Actividad a mostrar.");
	...
	public void informar(int resultado, TransferActividades actividad) {
		switch (resultado ) {
			case Controlador.OPERACION_CORRECTA: 	this.abrirVentana(new JFMostrarUno2(actividad));
													break;
