...
public class JFEliminar extends JFrame{
		...
		public class ALEliminar implements ActionListener{
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					Controlador.getInstance().actualiza(Controlador.ELIMINAR_ACTIVIDAD, id);
	...
	private void initGUI() {
		...
		JLabel texto = new JLabel("Introduzca el ID de la Actividad a eliminar.");
	...
	public void informar(int resultado) {
		switch (resultado ) {
			case Controlador.OPERACION_CORRECTA: JOptionPane.showMessageDialog
													(this, "Actividad eliminada con éxito.", "Actividad eliminada",
			...
			case Controlador.ACTIVIDAD_PASADA:  JOptionPane.showMessageDialog
													...
													JOptionPane.ERROR_MESSAGE); break;
			case Controlador.ACTIVIDAD_CON_PRESOS:  JOptionPane.showMessageDialog
													(this, "Actividad con presos apuntados", "Error",
													JOptionPane.ERROR_MESSAGE); break;
		}
	}
