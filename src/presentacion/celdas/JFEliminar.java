...
public class JFEliminar extends JFrame{
		...
		public class ALEliminar implements ActionListener{
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					Controlador.getInstance().actualiza(Controlador.ELIMINAR_CELDA, id);
	...
	private void initGUI() {
		...
		JLabel texto = new JLabel("Introduzca el ID de la Celda a eliminar.");
	...
	public void informar(int resultado) {
		switch (resultado ) {
			case Controlador.OPERACION_CORRECTA: JOptionPane.showMessageDialog
													(this, "Celda eliminada con éxito.", "Celda eliminada",
			...
			case Controlador.CELDA_NO_EXISTENTE: JOptionPane.showMessageDialog
													...
													JOptionPane.ERROR_MESSAGE); break;
			case Controlador.CELDA_CON_PRESOS: JOptionPane.showMessageDialog
													(this, "Celda con presos", "Error",
													JOptionPane.ERROR_MESSAGE); break;
		}
	}
