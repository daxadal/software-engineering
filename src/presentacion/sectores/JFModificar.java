...
public class JFModificar extends JFrame{
	public class JBModificar extends JButton{	
		...
		public class ALModificar implements ActionListener{
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					Controlador.getInstance().actualiza(Controlador.MOSTRAR_PARA_MODIFICAR_SECTOR, id);
		...
		public JBModificar() {
			super("Mostrar para modificar");
			this.addActionListener(new ALModificar());
		}
	}

	public JFModificar() {
		super("Modificar un Sector");
		setSize(400,130);
	...
	private void initGUI() {
		...
		JLabel texto = new JLabel("Introduzca el ID del Sector a modificar.");
	...
	public void informar(int resultado, TransferSector sector) {
		switch (resultado) {
		case Controlador.OPERACION_CORRECTA: 	this.abrirVentana(new JFModificar2(sector));
												break;
