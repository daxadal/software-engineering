...
public class JFMostrarUno extends JFrame{
		...
		public class ALMostrarUno implements ActionListener{
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					Controlador.getInstance().actualiza(Controlador.MOSTRAR_UN_SECTOR, id);
	...
	private void initGUI() {
		...
		JLabel texto = new JLabel("Introduzca el ID del Sector a mostrar.");
	...
	public void informar(int resultado, TransferSector sector) {
		switch (resultado ) {
			case Controlador.OPERACION_CORRECTA: 	this.abrirVentana(new JFMostrarUno2(sector));
													break;
