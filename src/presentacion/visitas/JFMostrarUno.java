...
public class JFMostrarUno extends JFrame{
		...
		public class ALMostrarUno implements ActionListener{
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					Controlador.getInstance().actualiza(Controlador.MOSTRAR_UNA_VISITA, id);
	...
	private void initGUI() {
		...
		JLabel texto = new JLabel("Introduzca el ID de la Visita a mostrar.");
	...
	public void informar(int resultado, TransferVisitas actividad) {
		switch (resultado ) {
