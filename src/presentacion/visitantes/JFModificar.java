...
public class JFModificar extends JFrame{
		...
		public class ALModificar implements ActionListener{
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					Controlador.getInstance().actualiza(Controlador.MOSTRAR_PARA_MODIFICAR_VISITANTE, id);
	...
	private void initGUI() {
		...
		JLabel texto = new JLabel("Introduzca el ID del Visitante a modificar.");
	...
	public void informar(int resultado, TransferVisitantes visitante) {
		switch (resultado ) {
		case Controlador.OPERACION_CORRECTA: 	this.abrirVentana(new JFModificar2(visitante));
												break;
