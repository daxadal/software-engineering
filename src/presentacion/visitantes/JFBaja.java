...
public class JFBaja extends JFrame{
		...
		public class ALBaja implements ActionListener{
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					Controlador.getInstance().actualiza(Controlador.BAJA_VISITANTE, id);
	...
	public JFBaja() {
		super("Dar de Baja un Visitante");
		setSize(500,130);
	...
	private void initGUI() {
		...
		JLabel texto = new JLabel("Introduzca el ID del Visitante que se va a dar de baja.");
	...
	public void informar(int resultado) {
		switch (resultado ) {
			case Controlador.OPERACION_CORRECTA: JOptionPane.showMessageDialog
													(this, "Visitante dado de baja con éxito.", "Visitante dado de baja",
			...
			case Controlador.VISITANTE_NO_EXISTENTE: JOptionPane.showMessageDialog
													...
													JOptionPane.ERROR_MESSAGE); break;
			case Controlador.VISITAS_PENDIENTES:JOptionPane.showMessageDialog
													(this, "Visitante con visitas pendientes", "Error",
													JOptionPane.ERROR_MESSAGE); break;
		}
	}
