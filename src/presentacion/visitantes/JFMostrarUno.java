...
public class JFMostrarUno extends JFrame{
		...
		public class ALMostrarUno implements ActionListener{
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					Controlador.getInstance().actualiza(Controlador.MOSTRAR_UNO_VISITANTE, id);
	...
	private void initGUI() {
		...
		JLabel texto = new JLabel("Introduzca el ID del Visitante a mostrar.");
	...
	public void informar(int resultado, TransferVisitantes visitante) {
		switch (resultado ) {
			case Controlador.OPERACION_CORRECTA: 	this.abrirVentana(new JFMostrarUno2(visitante));
													break;
